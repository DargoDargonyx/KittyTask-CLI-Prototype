...
#define ESTAT_GROUP_CONTAINER_CREATE 0x52
#define ESTAT_GROUP_CONTAINER_DESTROY 0x53
#define ESTAT_GROUP_ADD_TASK 0x54
#define ESTAT_GROUP_CONTAINER_ADD_GROUP 0x55
